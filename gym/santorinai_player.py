...
class ToMantoRinAI(player.Player):
    ...
    def play_move(
        ...
        action, _ = self.model.predict(state, action_masks=mask)
...
if __name__ == "__main__":
    ...
    # Play 100 games
    res = tester.play_1v1(player, choice(enemies), nb_games=nb_games)
    # Get first value of the dict:
    nb_win = list(res.values())[0]
